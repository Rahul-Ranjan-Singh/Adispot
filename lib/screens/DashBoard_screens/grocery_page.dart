...
import '../../data/grocery_product_data.dart';
import '../../models/grid_img_Info.dart';
import '../../models/product_model.dart';
import '../../widgets/appbar.dart';
import '../../widgets/filters_row_widget.dart';
...
class grocery_page extends StatefulWidget {
  ...
  @override
  State<grocery_page> createState() => _grocery_pageState();
}

class _grocery_pageState extends State<grocery_page> {

  List<grid_img_info> list = grid_img_data().getData();
  List<product> product_list = grocery_product_data().getData();
